...
describe('components', () => {
  describe('Footer', () => {
    ...
    it('should display active count when 0', () => {
      ...
      // @ts-expect-error TS(7022): 'count' implicitly has type 'any' because it does ... Remove this comment to see the full error message
      const [ count ] = output.props.children
      // @ts-expect-error TS(2448): Block-scoped variable 'count' used before its decl... Remove this comment to see the full error message
    ...
    it('should render filters', () => {
      ...
      const { output } = setup()
      // @ts-expect-error TS(7022): 'filters' implicitly has type 'any' because it doe... Remove this comment to see the full error message
      const [ , filters ] = output.props.children
      // @ts-expect-error TS(2448): Block-scoped variable 'filters' used before its de... Remove this comment to see the full error message
      ...
      filters.props.children.forEach(function checkFilter(filter: any, i: any) {
        ...
        // @ts-expect-error TS(7022): 'a' implicitly has type 'any' because it does not ... Remove this comment to see the full error message
        const a = filter.props.children
        // @ts-expect-error TS(2448): Block-scoped variable 'a' used before its declarat... Remove this comment to see the full error message
    ...
    it('shouldnt show clear button when no completed todos', () => {
      ...
      // @ts-expect-error TS(7022): 'clear' implicitly has type 'any' because it does ... Remove this comment to see the full error message
      const [ , , clear ] = output.props.children
      // @ts-expect-error TS(2448): Block-scoped variable 'clear' used before its decl... Remove this comment to see the full error message
