  ...
  describe('MainSection', () => {
    ...
    describe('toggle all input', () => {
      it('should render', () => {
        ...
        const { output } = setup()
        // @ts-expect-error TS(7022): 'toggle' implicitly has type 'any' because it does... Remove this comment to see the full error message
        const [ toggle ] = output.props.children[0].props.children
        // @ts-expect-error TS(2448): Block-scoped variable 'toggle' used before its dec... Remove this comment to see the full error message
    ...
    describe('footer', () => {
      it('should render', () => {
        // @ts-expect-error TS(2554): Expected 1 arguments, but got 0.
        const { output } = setup()
        // @ts-expect-error TS(7022): 'footer' implicitly has type 'any' because it does... Remove this comment to see the full error message
        const [ , , footer ] = output.props.children
        // @ts-expect-error TS(2448): Block-scoped variable 'footer' used before its dec... Remove this comment to see the full error message
    ...
    describe('visible todo list', () => {
      it('should render', () => {
        // @ts-expect-error TS(2554): Expected 1 arguments, but got 0.
        const { output } = setup()
        // @ts-expect-error TS(7022): 'visibleTodoList' implicitly has type 'any' becaus... Remove this comment to see the full error message
        const [ , visibleTodoList ] = output.props.children
        // @ts-expect-error TS(2448): Block-scoped variable 'visibleTodoList' used befor... Remove this comment to see the full error message
    ...
    describe('toggle all input and footer', () => {
      it('should not render if there are no todos', () => {
        ...
        // @ts-expect-error TS(7022): 'renderedChildren' implicitly has type 'any' becau... Remove this comment to see the full error message
        const renderedChildren = output.props.children
        .filter((item: any) => item !== false)
        // @ts-expect-error TS(2448): Block-scoped variable 'renderedChildren' used befo... Remove this comment to see the full error message
